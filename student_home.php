	...
	<div>		
		<table>
			...
			<th>FINE STATUS</th>
				...
				{
					echo "<div style='color:red;font-size:25px;display:inline-block;margin-top:20px;padding:30px'>No New Books..";
...
<div>
			...
			<a href="stud_history.php"><button class="button">HISTORY</button></a>
</div>
</div>
</body>
</html>