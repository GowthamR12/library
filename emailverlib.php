        ...
        {   
            ...
            {   
                ...
                if(mail($to, $subject, $message, $headers))
                {
                    ...
                    echo "<center><span style='  padding: 10px;background-color:black;opacity:0.8;position:relative;left: 10px;display:inline-block;color:white;'>PASSWORD SENT</span></center>";
                }
                else
